...
"""
    ...
    references:
        Dollar, Piotr, et al. "Pedestrian Detection: An Evaluation of the State of the Art.
        " Pattern Analysis and Machine Intelligence, IEEE , Transactions on 34.4 (2012): 743 - 761.
"""
...
def get_map(MINOVERLAP, draw_plot, score_threhold=0.5, path = './map_out'):
    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        if n_classes == 0:
            print("検出されたカテゴリがありません。ラベル情報を確認し、get_map.pyのclasses_pathが正しく変更されているかどうかを確認してください。")
            return 0
        results_file.write("\n# mAP of all classes\n")
...
def preprocess_gt(gt_path, class_names):
    ...
    for i, image_id in enumerate(image_ids):
        ...
        image['height']    = 1
        #-----------------------------------------------------------------#
        #  結果が「Results do not correspond to current coco set」という問題が解決されました。                                                                                                                                              ─╯
        #-----------------------------------------------------------------#
