...
from yolomodels.yolos.yolov4 import yolov4_body
from yolomodels.yolos.yolov3 import yolov3_body
from yolomodels.yolos.yolov5 import yolov5_body
from yolomodels.yolos.yolov7 import yolov7_body
...
class YOLO(object):
    ...
    _defaults = {
        ...
        #"model_path"        : 'logs/logs_%s/best_epoch_weights.h5' % (backbone),
        "neck"              : '',
        "backbone"          : '',
    ...
    def generate(self):
        ...
        elif self.neck == 'yolov4':
            yolo_body=yolov4_body
        elif self.neck == 'yolov5':
            yolo_body=yolov5_body
        elif self.neck == 'yolov7':
            yolo_body=yolov7_body

        self.model = yolo_body([self.imagesize, self.imagesize, 3], self.anchors_mask, self.num_classes, self.backbone)
    ...
    def detect_image(self, image, img_name, crop = False, count = False):
        ...
        print('Found {} boxes for {}'.format(len(out_boxes),img_name))
        #---------------------------------------------------------#
        #   设置字体与边框厚度
        #---------------------------------------------------------#
